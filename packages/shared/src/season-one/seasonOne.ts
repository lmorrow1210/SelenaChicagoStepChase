...
export const SEASON_ONE_CONFIG = {
    ...
    },
    {
      ...
      closeCopy: {
        ...
        close_encounter: {
          ...
          nextLead: "The final entry in the record is dated, initialed, and left otherwise blank.",
        },
        interception: {
          headline: "SELENA INTERCEPTED",
          ...
          nextLead: "A folded note left with the file, signed in the same hand as the record.",
        },
      },
      nextCityTeaser: {
        cityName: "",
  ...
  evidence: [
    ...
    },
    {
      ...
      enhancedBody: "A folded note: You kept pace with me for thirteen cities. No one else ever has. Rest well. — S.C.",
      highlightedFragment: "You kept pace with me for thirteen cities. No one else ever has.",
      iconKey: "note",
    },
  ],
