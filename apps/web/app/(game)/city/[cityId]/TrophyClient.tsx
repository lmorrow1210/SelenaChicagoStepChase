...
import CityBadge from "@one-step-ahead/design-system/components/game/CityBadge";
import LandmarkTile from "@one-step-ahead/design-system/components/game/LandmarkTile";
...
export default function PastCityPage() {
    ...
    return (
      <main className="trophyPage">
        <EmptyState
          ...
          action={
            <a className="trophyAction" href={withBase("/login")}>
              Continue
            </a>
          }
        />
    ...
    return (
      <main className="trophyPage">
        <EmptyState
          ...
          action={
            <a className="trophyAction" href={withBase("/map")}>
              Back to the map
            </a>
          }
        />
  ...
  return (
    <main className="trophyPage">
      <a className="backLink" href={withBase("/map")}>
        ← Map
      </a>
